...
do	--[[trains-vehicles]]--
	...
	aadd("z-trains-9",			"yir_emdf7a_mn",				"g")
	aadd("z-trains-8",			"yir_atom_header",				"h")
	aadd("z-trains-8",			"yir_atom_mitte",				"i")
	
	aadd("z-trains-9",			"yir_2acw_wood",				"a") 
	aadd("z-trains-9",			"y_wagon_coal",					"b")-- wagon 1 Amer
	aadd("z-trains-9",			"y_wagon_stone",				"c")
	aadd("z-trains-9",			"y_wagon_copper",				"d")
	aadd("z-trains-9",			"y_wagon_iron",					"e")
	aadd("z-trains-8",			"yir_emdf7b_cr",				"g")
	aadd("z-trains-9",			"yir_emdf7b_mn",				"h")
	
	aadd("z-trains-10",			"yir_cw_cargo_blue",			"a")
	aadd("z-trains-10",			"yir_cw_cargo_green",			"b") -- wagon 5 UP&Amer
	aadd("z-trains-10",			"z_yira_4a_cw_steel",			"c")
	aadd("z-trains-10",			"z_yira_6a_maai1",				"d")
	aadd("z-trains-10",			"yir_wagon_caboose_cr_crrecipe","e")
	aadd("z-trains-10",			"yir_wagon_caboose_cr",			"e")
	aadd("z-trains-10",			"yir_4a_container_crrecipe",	"f")
	aadd("z-trains-10",			"yir_4a_container_cr",			"f")
	aadd("z-trains-10",			"yir_4a_clean_cr",				"g")
	...
	aadd("z-trains-14",			"yir_cw_uranite",				"b") -- wagon 6 Industries
