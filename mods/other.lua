...
do	--[[liquids]]--
	...
	aadd("z-liquids-3",			"coal-liquefaction",			"c")
  ...
  if i_exist("bi-liquid-air") then
	...
	aadd("z-liquids-2",			"bi-Fuel_Conversion",			"a")
	radd("z-liquids-2",			"bi-biomass-0",					"b")
	aadd("z-liquids-2",			"bi-Bio_Fuel",					"c")
	radd("z-liquids-2",			"bi-Clean_Air",					"d")
	radd("z-liquids-2",			"bi-Clean_Air2",				"e")
	
	-- natural evolution
	aadd("z-liquids-1",			"NE_nutrient-solution",			"j")
	aadd("z-liquids-1",			"NE_basic-alien-nutrientant",	"j")
	aadd("z-liquids-3",			"NE_enhanced-nutrient-solution","j")
	aadd("z-liquids-3",			"NE_enhanced-alien-nutrientant","j")
	aadd("z-liquids-3",			"NE_alien-revitalization",		"l")
	
	-- n-tech chemistry
	aadd("z-liquids-1",	"basic-desulphurized-oil-processing",	"e")
	aadd("z-liquids-1",	"advanced-desulphurized-oil-processing","f")
	
	aadd("z-liquids-3",		"crude-oil-desulphurization",		"e")
	aadd("z-liquids-3",		"water-purification",				"a")
	
	aadd("z-liquids-6",		"petroleum-gas-barrel",				"i")
	aadd("z-liquids-6",		"fill-petroleum-gas-barrel",		"i")
	aadd("z-liquids-6",		"methanol-barrel",					"j")
	aadd("z-liquids-6",		"fill-methanol-barrel",				"j")
	aadd("z-liquids-6",		"disulfuric-acid-barrel",			"k")
	aadd("z-liquids-6",		"fill-disulfuric-acid-barrel",		"k")
	aadd("z-liquids-6",		"methylhydrazine-barrel",			"l")
	aadd("z-liquids-6",		"fill-methylhydrazine-barrel",		"l")
	aadd("z-liquids-6",		"dimethylhydrazine-barrel",			"m")
	aadd("z-liquids-6",		"fill-dimethylhydrazine-barrel",	"m")
	
	aadd("z-liquids-7",		"empty-petroleum-gas-barrel",		"i")
	aadd("z-liquids-7",		"empty-methanol-barrel",			"j")
	aadd("z-liquids-7",		"empty-disulfuric-acid-barrel",		"k")
	aadd("z-liquids-7",		"empty-methylhydrazine-barrel",		"l")
	aadd("z-liquids-7",		"empty-dimethylhydrazine-barrel",	"m")
	
	-- rail tanker
	iadd("z-liquids-10",		"crude-oil",						"d")
	iadd("z-liquids-10",		"heavy-oil",						"e")
	iadd("z-liquids-10",		"light-oil",						"f")
	iadd("z-liquids-10",		"bi-biomass",						"n")
	iadd("z-liquids-10",		"water-purified",					"p")
	iadd("z-liquids-10",		"water-floatation-waste",			"r")
	iadd("z-liquids-10",		"water-saline",						"s")
	iadd("z-liquids-10",		"crystal-seedling",					"t")
	iadd("z-liquids-10",		"crystal-matrix",					"u")
	iadd("z-liquids-10",		"crystal-slurry",					"v")
	iadd("z-liquids-10",		"thermal-water",					"w")
	iadd("z-liquids-10",		"mineral-sludge",					"x")
	iadd("z-liquids-10",		"slag-slurry",						"y")
	iadd("z-liquids-10",		"liquefied-coal",					"z")
	iadd("z-liquids-10",		"liquid-air-in-tanker",				"a")
	iadd("z-liquids-10",		"water-in-tanker",					"b")
	iadd("z-liquids-10",		"lithia-water-in-tanker",			"c")
	iadd("z-liquids-10",		"crude-oil-in-tanker",				"d")
	iadd("z-liquids-10",		"heavy-oil-in-tanker",				"e")
	iadd("z-liquids-10",		"light-oil-in-tanker",				"f")
	iadd("z-liquids-10",		"lubricant-in-tanker",				"g")
	iadd("z-liquids-10",		"liquid-fuel-in-tanker",			"h")
	iadd("z-liquids-10",		"ferric-chloride-solution-in-tanker","i")
	iadd("z-liquids-10",		"alien-goo-in-tanker",				"j")
	iadd("z-liquids-10",		"y-con_water-in-tanker",			"k", "__ZGroupChange__/graphics/icons/y-con-water.png")
	iadd("z-liquids-10",		"y-liquid-uc2-in-tanker",			"l")
	iadd("z-liquids-10",		"bi-Bio_Fuel-in-tanker",			"m")
	iadd("z-liquids-10",		"bi-biomass-in-tanker",				"n")
	iadd("z-liquids-10",		"bi-liquid-co2-in-tanker",			"o")
	iadd("z-liquids-10",		"water-purified-in-tanker",			"p")
	iadd("z-liquids-10",		"water-mineralized-in-tanker",		"q")
	iadd("z-liquids-10",		"water-floatation-waste-in-tanker",	"r")
	iadd("z-liquids-10",		"water-saline-in-tanker",			"s")
	iadd("z-liquids-10",		"crystal-seedling-in-tanker",		"t")
	iadd("z-liquids-10",		"crystal-matrix-in-tanker",			"u")
	iadd("z-liquids-10",		"crystal-slurry-in-tanker",			"v")
	iadd("z-liquids-10",		"thermal-water-in-tanker",			"w")
	iadd("z-liquids-10",		"mineral-sludge-in-tanker",			"x")
	iadd("z-liquids-10",		"slag-slurry-in-tanker",			"y")	
	iadd("z-liquids-10",		"liquefied-coal-in-tanker",			"z")
	
	ihide("liquid-chlor-methane-in-tanker")
	
	-- natural evolution
	iadd("z-liquids-11",	"NE_alien_toxin")
	iadd("z-liquids-11",	"NE_alien_toxin-in-tanker")
	iadd("z-liquids-11",	"NE_nutrient-solution-in-tanker")
	iadd("z-liquids-11",	"NE_basic-alien-nutrientant-in-tanker")
	iadd("z-liquids-11",	"NE_enhanced-nutrient-solution-in-tanker")
	iadd("z-liquids-11",	"NE_enhanced-alien-nutrientant-in-tanker")
	iadd("z-liquids-11",	"NE_alien-revitalization-in-tanker")
	iadd("z-liquids-11",	"NE_revitalization-solition-in-tanker")
...
do	--[[transport]]--
	...
	aadd("z-transport-0",			"belt-sorter-advanced",		"i")
  ...
  if i_not_exist("5d-pipe-mk2") and i_not_exist("copper-pipe") then
	aadd("z-transport-12",			"pipe-straight",			"d")
	aadd("z-transport-12",			"pipe-junction",			"e")
	aadd("z-transport-12",			"pipe-elbow",				"f")
  elseif allow_changes and i_exist("copper-pipe") and i_not_exist("5d-pipe-mk2") then
	aadd("z-transport-14",			"pipe-straight",			"a")
	aadd("z-transport-14",			"pipe-copper-straight",		"b")
	aadd("z-transport-14",			"pipe-steel-straight",		"c")
	aadd("z-transport-15",			"pipe-junction",			"a")
	aadd("z-transport-15",			"pipe-copper-junction",		"b")
	aadd("z-transport-15",			"pipe-steel-junction",		"c")
	aadd("z-transport-16",			"pipe-elbow",				"a")
	aadd("z-transport-16",			"pipe-copper-elbow",		"b")
	aadd("z-transport-16",			"pipe-steel-elbow",			"c")
  elseif allow_changes then
	aadd("z-transport-13",			"pipe-straight",			"d")
	aadd("z-transport-13",			"pipe-copper-straight",		"e")
	aadd("z-transport-13",			"pipe-steel-straight",		"f")
	aadd("z-transport-14",			"pipe-junction",			"d")
	aadd("z-transport-14",			"pipe-copper-junction",		"e")
	aadd("z-transport-14",			"pipe-steel-junction",		"f")
	aadd("z-transport-15",			"pipe-elbow",				"d")
	aadd("z-transport-15",			"pipe-copper-elbow",		"e")
	aadd("z-transport-15",			"pipe-steel-elbow",			"f")
  else
	aadd("z-transport-12",			"pipe-straight",			"d")
	aadd("z-transport-12",			"pipe-junction",			"e")
	aadd("z-transport-12",			"pipe-elbow",				"f")
	...
	-- flow control bob
	if not z_balance.bob_pipes then
		aadd("z-transport-9",	"pipe-stone-straight",			"a")
		aadd("z-transport-9",	"pipe-copper-straight",			"b")
		aadd("z-transport-9",	"pipe-steel-straight",			"c")
		aadd("z-transport-9",	"pipe-bronze-straight",			"d")
		aadd("z-transport-9",	"pipe-plastic-straight",		"e")
		aadd("z-transport-9",	"pipe-brass-straight",			"f")
		aadd("z-transport-9",	"pipe-ceramic-straight",		"g")
		aadd("z-transport-9",	"pipe-titanium-straight",		"h")
		aadd("z-transport-9",	"pipe-tungsten-straight",		"i")
		
		aadd("z-transport-10",	"pipe-stone-junction",			"a")
		aadd("z-transport-10",	"pipe-copper-junction",			"b")
		aadd("z-transport-10",	"pipe-steel-junction",			"c")
		aadd("z-transport-10",	"pipe-bronze-junction",			"d")
		aadd("z-transport-10",	"pipe-plastic-junction",		"e")
		aadd("z-transport-10",	"pipe-brass-junction",			"f")
		aadd("z-transport-10",	"pipe-ceramic-junction",		"g")
		aadd("z-transport-10",	"pipe-titanium-junction",		"h")
		aadd("z-transport-10",	"pipe-tungsten-junction",		"i")
		
		aadd("z-transport-11",	"pipe-stone-elbow",				"a")
		aadd("z-transport-11",	"pipe-copper-elbow",			"b")
		aadd("z-transport-11",	"pipe-steel-elbow",				"c")
		aadd("z-transport-11",	"pipe-bronze-elbow",			"d")
		aadd("z-transport-11",	"pipe-plastic-elbow",			"e")
		aadd("z-transport-11",	"pipe-brass-elbow",				"f")
		aadd("z-transport-11",	"pipe-ceramic-elbow",			"g")
		aadd("z-transport-11",	"pipe-titanium-elbow",			"h")
		aadd("z-transport-11",	"pipe-tungsten-elbow",			"i")
	else
