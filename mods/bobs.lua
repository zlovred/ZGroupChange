...
do	--[[gathering]]--
  ...
  elseif allow_changes then
	...
	aadd("z-gathering-9",		"water-miner-1",			"a")
	aadd("z-gathering-9",		"water-miner-2",			"b")
	aadd("z-gathering-9",		"water-miner-3",			"c")
	aadd("z-gathering-9",		"water-miner-4",			"d")
	aadd("z-gathering-9",		"water-miner-5",			"e")
	aadd("z-gathering-9",		"pumpjack",					"f")
	aadd("z-gathering-9",		"bob-pumpjack-1",			"g")
	aadd("z-gathering-9",		"bob-pumpjack-2",			"h")
	aadd("z-gathering-9",		"bob-pumpjack-3",			"i")
	aadd("z-gathering-9",		"bob-pumpjack-4",			"j")
...
do	--[[production]]--
	...
	aadd("z-production-0",		"5d-furnace",					"f")
	aadd("z-production-0",		"5d-masher",					"g")
	aadd("z-production-0",		"5d-masher-2",					"h")
	...
	aadd("z-production-2",		"chemical-furnace",				"g")
	aadd("z-production-2",	"electric-chemical-mixing-furnace",	"h")
	aadd("z-production-2",	"electric-chemical-mixing-furnace-2","i")
	...
	aadd("z-production-4",		"assembling-machine-4",			"d")
	aadd("z-production-4",		"assembling-machine-5",			"e")
	aadd("z-production-4",		"assembling-machine-6",			"f")
...
do	--[[logistic]]--
	...
	aadd("z-logistic-1",		"bob-roboport-3",					"d")
	aadd("z-logistic-1",		"bob-roboport-4",					"e")
...
do	--[[defense]]--
	...
	if i_exist("bob-gun-turret-2") then 
		...
		aadd("z-defense-4",			"bob-gun-turret-3",				"e")
		aadd("z-defense-4",			"bob-gun-turret-4",				"f")
		aadd("z-defense-4",			"bob-gun-turret-5",				"g")
...
do	--[[trains-vehicles]]--
	if not z_balance.bob_transport then
		...
		aadd("z-vehicles-4",		"scatter-cannon-shell",			"c")
		aadd("z-vehicles-4",		"poison-artillery-shell",		"d")
		aadd("z-vehicles-4",		"explosive-artillery-shell",	"e")
		aadd("z-vehicles-4",		"distractor-artillery-shell",	"f")
	else
		ahide("gatling-gun")
		ahide("tank-laser")
		ahide("tank-2")
