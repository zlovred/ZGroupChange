...
do	--[[gathering]]--
  ...
  if not allow_changes then
	...
	aadd("z-gathering-4",		"y-mining-drill",				"z")
	aadd("z-gathering-5",		"y-mining-drill-e2",			"z")
	aadd("z-gathering-6",		"y-underground-drill",			"z")
...
do	--[[plates]]--
	aadd("z-plates-9",			"y-refined-iron",				"h")
	aadd("z-plates-9",			"y-refined-copper",				"i")
	
	aadd("z-plates-10",			"y_hps_pureiron_recipe",		"h")
	aadd("z-plates-10",			"y_hps_purecopper_recipe",		"i")
...
do	--[[youki]]--
	if i_exist("y-atomic-constructor") then zgc.add_main_group("youki") end
